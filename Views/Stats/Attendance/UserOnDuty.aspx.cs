...
public partial class Views_Stats_Attendance_UserOnDuty : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        divScript.InnerHtml = MicroForm.GetLayCheckBoxTpl(HttpUtility.HtmlEncode(ShortTableName), HttpUtility.HtmlEncode(ModuleID)); // Encode to prevent XSS
    ...
    protected string GetDeptNav()
    {
        ...
        catch (Exception ex) { flag = HttpUtility.HtmlEncode(ex.ToString()); } // Encode exception message to prevent XSS
